package kr.hs.emirim.s2019w09.baseapp;
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.toastButton :
                Toast.makeText(this, "나 클릭되었어요", Toast.LENGTH_SHORT).show(); break;
            case R.id.checkBox1 :
            case R.id.checkBox2 :
                CheckBox check = (CheckBox) view;
                Toast.makeText(this, "내가 좋아하는 것은" + check.getText(), Toast.LENGTH_SHORT).show(); break;
        }
